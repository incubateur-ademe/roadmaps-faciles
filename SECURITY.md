...
Ce document décrit les procédures de sécurité et les politiques générales pour le projet 'roadmap.incubateur.net'.
...
La communauté et l’équipe cœur de 'roadmap.incubateur.net' prennent au très au sérieux la sécurité de l’application.
