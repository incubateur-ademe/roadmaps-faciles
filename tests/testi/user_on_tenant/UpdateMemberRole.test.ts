...
describe("UpdateMemberRole", () => {
  ...
  // TODO: CLAUDE.md Security — l'implémentation devrait aussi bloquer OWNER comme rôle cible
  // Ce test documente le comportement actuel (OWNER cible autorisé), à corriger dans le use case
