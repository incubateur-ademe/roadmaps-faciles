...
description: Architecture du tracking, plan d'événements AARRR et configuration des fournisseurs (noop, Matomo, PostHog).
---
...
## Plan de tracking — AARRR

Le plan de tracking suit le framework **AARRR Pirate Metrics**, adapté au service public (Impact remplace Revenue).
