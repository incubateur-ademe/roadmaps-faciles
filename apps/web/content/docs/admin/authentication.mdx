...
<Callout type="info">
  Sur l'instance beta.gouv.fr, une méthode de connexion supplémentaire est disponible via **Espace Membre**. Cette méthode est spécifique à cette instance et n'est pas disponible sur les instances auto-hébergées.
</Callout>
